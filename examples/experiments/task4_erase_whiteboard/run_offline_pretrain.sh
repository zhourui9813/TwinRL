...
export PYTHONPATH="/media/zhourui/Twin-RL/conrft/octo:$PYTHONPATH" 
export DISPLAY=""
...
EXP_NAME=task5_erase_whiteboard
DEMO_PATH=/media/zhourui/data/twin-rl/task5_erase_whiteboard/mix/zero_state/mix_erase_whiteboard_delta_normalized_zero_state.pkl
