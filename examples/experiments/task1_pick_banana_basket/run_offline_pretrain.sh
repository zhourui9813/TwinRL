...
export PYTHONPATH="/media/zhourui/Twin-RL/octo:$PYTHONPATH" 
export DISPLAY=""
...
EXP_NAME=task1_pick_banana_basket
DEMO_PATH=/media/zhourui/data/twin-rl/test_data/sft_preprocess_test/test_data_delta_normalized_zero_state.pkl

NOW_TIME=$(date +"%Y-%m-%d_%H-%M-%S")
CKPT_ROOT=/media/zhourui/data/twin-rl/test_data/sft_preprocess_test/test_ckpt
CHECKPOINT_PATH="${CKPT_ROOT}/${NOW_TIME}_offline_train/"
