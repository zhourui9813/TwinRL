...
```bash
curl -X POST http://127.0.0.2:5000/activate_gripper # Activate gripper
curl -X POST http://127.0.0.2:5000/close_gripper # Close gripper
curl -X POST http://127.0.0.2:5000/open_gripper # Open gripper
